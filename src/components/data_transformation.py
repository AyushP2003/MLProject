...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artifact','proerocessor.pkl')
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(f'Applying preprocssing object onto training dataframe and testing dataframe')
            ...
            logging.info('Saved preprocssing objects')
